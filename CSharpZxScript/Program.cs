...
namespace CSharpZxScript
{
    internal class Program : ConsoleAppBase
    {
        ...
        public async Task<int> DefaultRun(
            ...
            [Option("fr")] string targetFrameWork = DefaultDotnetVersion,
            [Option("xv", "https://github.com/Cysharp/ProcessX")] string processXVersion = DefaultProcessXVersion,
...
");
        ...
        public async Task SettingsAddPackage(
            ...
            [Option("v", "Version:1.5.5")] string version = "",
            [Option("sd")] string settingDirectory = ".")
        {
